	...
	return (
		<Box as="section" py={{ base: 10, md: 14 }}>
			<Container maxW="7xl">
				<Stack gap={6}>
					<SectionHeader
						title="Curriculum Designed & Verified by Industry Experts"
						subtitle="Learn skills and concepts validated by industry professionals who use them in real-world work every day."
					/>
